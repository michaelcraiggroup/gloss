...
@State private var inspectorIsShown = false
    ...
    private var toolbarContent: some ToolbarContent {
        if !settings.isZenMode {
            // System items only — the vault library lives at the TOP OF THE
            // SIDEBAR (iOS parity) and hides with it. Design call 2026-08-09.
...
// FolderWatchHandler, RecentsRecorder, and VaultLifecycleHandler moved to
// VaultSessionModifiers.swift — shared vault-session glue for both app shells.
